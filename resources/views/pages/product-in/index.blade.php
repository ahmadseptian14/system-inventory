                    ...
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('product-in.create') }}" class="btn btn-primary mb-3"> + Tambah Produk Masuk
                                Baru</a>
                                <a href="{{route('product-in.exportAll')}}" class="btn btn-danger mb-3">Cetak PDF</a>
                            <div>
                                <table
                                    ...
                                    <tbody>
                                        @forelse ($product_ins as $product_in)
                                            <tr>
                                                ...
                                                <td>{{$product_in->date}}</td>
                                                <td>
                                                    <a href="{{ route('product-in.exportInvoice', [ 'id' => $product_in->id ]) }}" class="btn btn-sm btn-danger">Export PDF</a>
